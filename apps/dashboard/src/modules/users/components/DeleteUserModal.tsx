...
import { deleteUser } from '@/api/mutations/users.mutation';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-[#0F1C30] border border-[#1E3150] rounded-xl shadow-2xl">
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#1E3150]">
          <h2 className="text-white font-semibold text-base">Delete User</h2>
        ...
        <div className="px-6 py-5">
          ...
          {mutation.isError && (
            <p className="mt-4 text-sm text-red-400">Failed to delete user. Please try again.</p>
          )}
