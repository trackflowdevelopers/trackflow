...
const ROLE_STYLES: Record<UserRole, string> = {
  ...
  [UserRole.COMPANY_ADMIN]: 'bg-orange-900/30 text-orange-400 border-orange-800/40',
...
export function UsersTable({ data, sortOrder, onSort, onEdit, onDelete }: UsersTableProps) {
  const columns = [
